...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Araç Kiralama Otomasyonu v2.4 (Modular)")
        ...
        self.stack.addWidget(self.page_dashboard) # 1
        self.stack.addWidget(self.page_rental)    # 2
        self.stack.addWidget(self.page_report)    # 3
...
if __name__ == "__main__":
    ...
    # Windows görev çubuğu ikonu düzeltmesi
    try:
        import ctypes
